...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        host: 'Host',
        path: 'Caminho',
        worktreePath: 'Árvore de trabalho',
        ...
        updateCliInstructions: 'Por favor execute pnpm add -g happy@latest',
    ...
    tools: {
        ...
        names: {
            ...
            question: 'Pergunta',
            taskOutput: 'Saída de tarefa',
            taskStop: 'Tarefa concluída',
        },
        desc: {
