...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Esegui pnpm add -g happy@latest',
    ...
    tools: {
        ...
        names: {
            ...
            question: 'Domanda',
            taskOutput: 'Output del task',
            taskStop: 'Task completato',
        },
        desc: {
